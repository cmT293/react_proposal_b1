...
import JokesTen from './components/JokesTen';
import "./index.css"
...
ReactDOM.render(
    //Higher order component takes another component as an input (Header)
        // <Router history={history}>
        // <Switch>
        //     {/* So you dont have to include <Header/> on every component */}
        //     <Route exact path='/' render={() => <Header><App/></Header>}/>
        //     <Route path='/jokes' render={() => <Header><Jokes/></Header>}/>
        //     <Route path='/jokesTen' render={() => <Header><JokesTen/></Header>}/>
        //     {/* <Route path='/jokes' component={Jokes}/>
        //     <Route path='/jokesTen' component={JokesTen}/> */}
        // </Switch>  
        // </Router>, 
...
<body>
    <header>
      <div className={"main_menu"}>
        <div className={"earch_input"} id={"search_input_box"}>
            ...
            >
              <ul className={'nav navbar-nav menu_nav ml-auto'}>
                <li className={'nav-item active'}>
                  <a className={'nav-link'} className={"index.html"}>Home</a>
                </li>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This is made with <i class="ti-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a>
{/* <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --> */}
          </p>
